/*
  ...
  - You are about to alter the column `lengthOfEvents` on the `Schedule` table. The data in that column could be lost. The data in that column will be cast from `VarChar(191)` to `Int`.
...
ALTER TABLE `Schedule` MODIFY `startDate` DATETIME NOT NULL,
    ...
    MODIFY `lengthOfEvents` INTEGER NOT NULL;
